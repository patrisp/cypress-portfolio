...
describe('Verify that users have access to Matchmaking if requirements are met ', ()=>{
    ...
    function checkPopupMessage(profileInfo, preferencesInfo){
    ...
    it('Pop-up is displayed if neither user profile nor preferences are completed', ()=>{
        ...
        checkPopupMessage('Complete your profile to apply through matchmaking','Fill preferences to see your job matches');
        });

    it('Pop-up is displayed if only user profile is completed', ()=>{
        cy.login(users.user2, users.password); 

        checkPopupMessage('Your profile is complete!','Fill preferences to see your job matches');
        });

    it('Pop-up is displayed if only preferences are completed', ()=>{
        cy.login(users.user3, users.password); 

        checkPopupMessage('Complete your profile to apply through matchmaking','Your matchmaking preferences are complete!');
        });
